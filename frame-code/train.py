...
message = tk.Label(window, text="Face-Recognition-And-Matching-Engine" ,bg="blue"  ,fg="black"  ,width=50  ,height=3,font=('times', 30, 'italic bold underline')) 
...
lbl3 = tk.Label(window, text="User : ",width=20  ,fg="red"  ,bg="yellow"  ,height=2 ,font=('times', 15, ' bold  underline')) 
...
copyWrite.insert("insert", "Developed by Team FRAME","", "", "superscript")
